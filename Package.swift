...
var package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/Motonao-Suzue/Swallow-custom.git", branch: "keep_using_swiftlang"),
        .package(url: "https://github.com/preternatural-fork/swift-subprocess.git", branch: "release/0.2.1")
    ],
    targets: [
        .target(
            name: "SwiftDI",
